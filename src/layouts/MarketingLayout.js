  ...
  return (
    <div className={`relative min-h-screen w-full max-w-full overflow-x-hidden ${wrapperClass}`}>
      ...
      <div className="relative z-10 w-full">
        <div ref={navbarRef} className="fixed top-0 left-0 right-4 z-40" style={navbarStyle}>
          <Navbar />
        </div>
        <MenuMobile
          open={menuMobileOpen}
        ...
        />
        <main className="w-full max-w-full overflow-y-scroll h-screen pt-16 relative z-30" id="main-scroll">
          {children}
          <Footer />
        </main>
